    ...
    if 'llava' in model_name.lower():
        ...
        if 'lora' in model_name.lower() and model_base is not None:
            if 'mistral' in model_base:
                ...
                print('Loading LLaVAMistral from base model...')
            ...
            if force_vision_tower_path is not None:
                ...
                # [NOTE][HACK] Let me just fix here
                model.model.vision_tower = vision_tower
            
            if force_projector_path is not None:
                mm_projector_path = force_projector_path
            else:
                mm_projector_path = os.path.join(model_path, 'mm_projector.bin')
            
            if os.path.exists(mm_projector_path):
                print(f"Trying to load the projector path: {mm_projector_path}")
                ...
                model.model.mm_projector.load_state_dict(get_w(mm_projector_weights, 'mm_projector'))

            print('Loading additional LLaVA weights...')
            if os.path.exists(os.path.join(model_path, 'non_lora_trainables.bin')):
                non_lora_trainables = torch.load(os.path.join(model_path, 'non_lora_trainables.bin'), map_location='cpu')
            else:
                raise ValueError(f'Did not find non_lora_trainables.bin in: {model_path}')
            ...
            print('Loading LLaVA (mm projector?) from base model...')
            ...
            if 'mistral' in model_name.lower():
                print(f'[llavamed/llava/model/builder]-------------------> loading mistral!')
