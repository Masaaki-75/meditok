...
from .constants import OPENAI_DATASET_MEAN, OPENAI_DATASET_STD, BIOMEDCLIP_CFG, BIOMEDBERT_DIR
...
def get_biomedclip_tokenizer_offline(config_path=BIOMEDCLIP_CFG):
    with open(config_path, 'r') as f:
        config = json.load(f)['model_cfg']
    config['text_cfg']['hf_model_name'] = BIOMEDBERT_DIR
    config['text_cfg']['hf_tokenizer_name'] = BIOMEDBERT_DIR
    text_config = config.get('text_cfg', {})
    context_length = text_config.get('context_length', 256)
